...
if __name__ == "__main__":
    ...
    mesh_ice = load_textured_obj("models/cube.obj", "models/ice_texture.jpg")
    # load_obj does not work ?
    #rink = load_obj("models/mini_ice_rink.obj")
    ...
    #ice
    mesh_ice.grow(glm.vec3(4, 2, 0))
    #mesh_ice.grow(glm.vec3(1, 1, 1))
    #mesh_ice.move(glm.vec3(-0.2, 0, -0.9))
    mesh_ice.move(glm.vec3(0, 0, -0.9))
    #mesh_ice.rotate(glm.vec3(0.1, 0, 0))
    mesh_ice.rotate(glm.vec3(0.2, 0, 0))
    ...
    while not done:
        ...
        renderer.render(perspective, camera, glm.vec4(0.5, 0.2, 1.0, 1.0), [mesh_stick])
        renderer.render(perspective, camera, glm.vec4(0.7, 0.0, 0.2, 12.0), [puck])
        renderer.render(perspective, camera, glm.vec4(0.2, 0.2, 1.0, 32.0), [mesh_goal])
        renderer.render(perspective, camera, glm.vec4(1.0, 0.0, 0.0, 0.0), [mesh_ice])
