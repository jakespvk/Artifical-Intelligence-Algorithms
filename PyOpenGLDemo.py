...
if __name__ == "__main__":
    ...
    while not done:
        ...
        #square
        square_vertices = [(0.7, -0.9, 0), (0.7, -0.5, 0), (0.3, -0.9, 0), (0.3, -0.5, 0)]
        glBegin(GL_TRIANGLES)
        ...
        #rhombus
        rhombus_vertices = [(-0.8, 0.1, 0), (-0.6, 0.6, 0), (-0.2, 0.1, 0), (0, 0.6, 0)]
        glBegin(GL_TRIANGLES)
        glVertex3fv(rhombus_vertices[0])
        glVertex3fv(rhombus_vertices[1])
        glVertex3fv(rhombus_vertices[2])
        glEnd()

        glBegin(GL_TRIANGLES)
        glVertex3fv(rhombus_vertices[3])
        glVertex3fv(rhombus_vertices[1])
        glVertex3fv(rhombus_vertices[2])
        glEnd()
        ...
        #hexagon
        hexagon_vertices = [(-0.8, -0.6, 0), (-0.6, -0.4, 0), (-0.4, -0.4, 0), (-0.2, -0.6, 0), (-0.4, -0.8, 0), (-0.6, -0.8, 0)]
        glBegin(GL_TRIANGLES)
        glVertex3fv(hexagon_vertices[0])
        glVertex3fv(hexagon_vertices[1])
        glVertex3fv(hexagon_vertices[5])
        glEnd()

        glBegin(GL_TRIANGLES)
        glVertex3fv(hexagon_vertices[1])
        glVertex3fv(hexagon_vertices[2])
        glVertex3fv(hexagon_vertices[5])
        glEnd()

        glBegin(GL_TRIANGLES)
        glVertex3fv(hexagon_vertices[4])
        glVertex3fv(hexagon_vertices[5])
        glVertex3fv(hexagon_vertices[2])
        glEnd()
        ...
        glBegin(GL_TRIANGLES)
        glVertex3fv(hexagon_vertices[2])
        glVertex3fv(hexagon_vertices[3])
        glVertex3fv(hexagon_vertices[4])
        glEnd()
